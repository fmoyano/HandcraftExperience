...
extern int graphics_system_create_vshader(const wchar_t* path_to_source, ID3D11VertexShader** vertex_shader);
extern int graphics_system_create_pshader(const wchar_t* path_to_source, ID3D11PixelShader** pixel_shader);
